...
// Sizes are kept slightly larger than stock Material defaults per the
// product requirement that shopkeepers (including older users) can read
// everything at a glance without zooming.
